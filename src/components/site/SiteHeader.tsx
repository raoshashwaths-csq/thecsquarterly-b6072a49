  ...
  return (
    <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border">
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="group mr-8 leading-none shrink-0">
          <span className="font-display tracking-tight leading-none text-2xl">
            The CS Quarterly<span aria-hidden className="inline-block h-[7px] w-[7px] rounded-full bg-secondary-accent group-hover:bg-accent transition-colors ml-[1px] align-baseline translate-y-[1px]" />
          </span>
        </Link>
