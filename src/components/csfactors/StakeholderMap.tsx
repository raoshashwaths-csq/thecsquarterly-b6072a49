    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-12 gap-2 items-end p-3 bg-muted/30 border border-border">
        <div className="col-span-12 md:col-span-3">
          <label className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Contact</label>
          <Input
        ...
        <div className="col-span-6 md:col-span-2">
          <label className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Role</label>
        ...
        <div className="col-span-3 md:col-span-2">
          <label className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Influence</label>
        ...
        <div className="col-span-3 md:col-span-2">
          <label className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Sentiment</label>
      ...
      <div>
        ...
        <div className="flex justify-between font-mono text-xs uppercase tracking-widest text-muted-foreground mt-1">
