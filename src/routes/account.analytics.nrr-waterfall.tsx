              ...
              {cols.map((c) => {
                ...
                return (
                  <div key={c.label} className="flex flex-col items-center h-full justify-end">
                    <div className="font-mono text-xs md:uppercase tracking-widest text-xs tabular-nums mb-1 text-center">
                    ...
                    <div className="font-mono text-xs md:uppercase tracking-widest text-xs text-muted-foreground mt-2 text-center leading-tight">
                      {c.label}
                    </div>
                  </div>
                );
